//
//  ActionSheetTimeRangePicker.swift
//
...
class ActionSheetDateRangePicker: AbstractActionSheetPicker {
    ...
    static func showPicker(
        ...
        origin: UIView,
        minutesInterval: Int = 5
        ) -> ActionSheetTimeRangePicker {

        let picker = ActionSheetTimeRangePicker(
            title: title,
    ...
    fileprivate func refreshStartDates() {
        ...
        endDateComponentStartDate = Date(
            timeInterval: TimeInterval(0),//TimeInterval(minimumRangeDurationInMinutes * 60),
...
extension ActionSheetDateRangePicker: UIPickerViewDelegate, UIPickerViewDataSource {
